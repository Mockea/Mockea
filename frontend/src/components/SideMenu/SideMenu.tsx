...
export const SideMenu = ({toggleMenu} : SideMenuProps) => {
  return (
    <aside className="h-full absolute z-10 bg-white border p-10 grid grid-cols-[1fr_3fr]">
          <div className="side-menu__cross text-center" onClick={() => toggleMenu(false)}><i className="fa-solid fa-xmark rounded-full hover:bg-hovergrey px-3.5 py-5 fa-lg active:bg-clickgrey"></i></div>
          <div className="side-menu__content">
            ...
            <div className="side-menu__content-links flex flex-col gap-4 mt-6">
              ...
              <a href="" className="border border-black rounded-full flex gap-4 items-center p-1 mt-5"><i className="fa-solid fa-globe fa-lg "></i>Change country</a>
            </div>
          </div>
        </aside>
  )
